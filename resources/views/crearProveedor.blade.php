	...
	<form class="form-inline" type="get" action="{{ url('/almacenar-proveedor') }}">
		...
		<div class="row" style="background : orange;">
			...
			<div class="mb-3 col-md-2">
				...
				<input style="text-transform:uppercase" type="text" class="form-control" id="comuna_prov" name="comuna_prov" required onkeyup="javascript:this.value=this.value.toUpperCase();">
				<small id="dir_bod" class="form-text text-muted"> comuna del proveedor </small>
			</div>
			<div class="mb-3 col-md-2">
				<label for="ciudad_prov">Ciudad</label>
				<input style="text-transform:uppercase" type="text" class="form-control" id="ciudad_prov" name="ciudad_prov" required onkeyup="javascript:this.value=this.value.toUpperCase();">
				<small id="dir_bod" class="form-text text-muted"> ciudad del proveedor.</small>
			</div>
			<div class="mb-3 col-md-2">
				<label for="telefono_prov">Telefono </label>
				<input style="text-transform:uppercase" type="text" class="form-control" id="telefono_prov" name="telefono_prov" onkeyup="javascript:this.value=this.value.toUpperCase();">
				<small id="dir_bod" class="form-text text-muted">Numero contacto</small>
			</div>
		</div>
        <br>
		...
		<br>
		<input type="submit" class="btn btn-primary"  value=" Grabar "> </input>
	</div>
</form>
<div id="error"> </div>
