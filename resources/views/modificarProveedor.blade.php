			...
			<form class="form-inline" type="get" action="{{ url('/actualizar-proveedor') }}">
				...
				<div class="row" style="background : orange;">
					...
					<div class="mb-3 col-md-2">
						...
						<input value="{{$proveedor->ciudad_prov}}" style="text-transform:uppercase" type="text" class="form-control" id="ciudad_prov" name="ciudad_prov" required onkeyup="javascript:this.value=this.value.toUpperCase();">
						<small id="dir_bod" class="form-text text-muted"> ciudad del proveedor.</small>
					</div>
					<div class="mb-3 col-md-2">
						<label for="telefono_prov">Telefono </label>
						<input value="{{$proveedor->telefono_prov}}" style="text-transform:uppercase" type="text" class="form-control" id="telefono_prov" name="telefono_prov" onkeyup="javascript:this.value=this.value.toUpperCase();">
