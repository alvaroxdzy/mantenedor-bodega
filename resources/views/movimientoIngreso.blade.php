...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#agregar_btn').on('click',function(){
            ...
            html+='<td style="width:100px"><input style="width:100px" id="cantidad'+contador+'" class="form-control" oninput="multiplicar(this)" type="text" name="cantidad" required placeholder="" onkeypress="return valideKey(event);" re></td>';
